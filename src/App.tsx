...
const projects: Project[] = [
  {
    ...
    details: {
      ...
      abilities: [
        ...
        'When a post is marked as **“ready to be posted”**, it is automatically published to the Telegram channel',
      ],
      setup:
        'A series of AI nodes perform the following tasks: Validate that an article matches the posting criteria; Check the database to prevent duplicate news; Summarize the article and save structured data to Notion; Find or generate a relevant cover image; Rephrase and format the content for clean Telegram delivery.',
